...
const PlaceOrder = () => {
    ...
    return (
        <form onSubmit={onSubmitHandler} className='flex flex-col sm:flex-row justify-between gap-4 pt-[44px] sm:pt-[44px] min-h-[80vh] border-t'>
            {/* ------------- Left Side ---------------- */}
            <div className='flex flex-col gap-4 w-full sm:max-w-[480px]'>
                ...
                <input required onChange={onChangeHandler} name='dienThoai' value={formData.dienThoai} className='border border-gray-300 py-1.5 px-3.5 w-full' type="number" placeholder='Điện thoại' />
