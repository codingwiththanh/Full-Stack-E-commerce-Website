      ...
      <div className="flex flex-col sm:flex-row justify-center items-center my-8 gap-8 flex-wrap shadow-2xl w-[90%] max-w-4xl bg-white ">
        ...
        >
          ...
          <div className="w-full flex justify-between text-[18px] mt-1">
            <p className="cursor-pointer hover:text-gray-600">Quên mật khẩu?</p>
            <p
          ...
          <button
            type="submit"
            disabled={isLoading}
            className={`bg-black text-white uppercase font-medium px-8 py-2 mt-4 hover:bg-gray-800 transition w-full ${isLoading ? 'opacity-50 cursor-not-allowed' : ''}`}
          >
