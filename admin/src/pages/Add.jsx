...
const Add = ({ token }) => {
  ...
  return (
    <form onSubmit={onSubmitHandler} className='flex flex-col w-full items-start gap-3 mx-auto ml-4 mt-4'>
      {/* Ảnh */}
      <div>
        <p className='mb-2'>Tải lên ảnh</p>
      ...
      <div className='w-full'>
        ...
        <textarea onChange={(e) => setDescription(e.target.value)} value={description} className='w-full max-w-[500px] px-3 py-2' placeholder='Nhập mô tả' required />
      </div>

      {/* Danh mục + Thể loại + Giá */}
      ...
      {/* Size */}
      <div>
        <p className='mb-2'>Chọn kích cỡ</p>
      ...
      {/* Submit */}
      <button type="submit" className='w-28 py-3 mt-4 bg-black text-white'>THÊM MỚI</button>
    </form>
  )
}
